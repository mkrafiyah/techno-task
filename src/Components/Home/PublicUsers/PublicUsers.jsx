...
const PublicUsers = () => {
    return (
       <div>
        ...
        <div className="flex-1 pr-10 my-auto">
        <p className="text-xl font-medium text-sky-900">People from various background can use this. It will help them to manage the tasks easily by giving less efforts.By using this app there daily life will be easy.</p>
        </div>
       </div>
        </div>
    );
